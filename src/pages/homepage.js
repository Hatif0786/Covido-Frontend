            ...
            <div className="row d_flex grid">
               ...
               <div className="col-md-5 oder1">
                  <div className="titlepage text_align_left">
                     ...
                     <a className="read_more" href="coronata.html">About More</a>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div className="col-md-12">
                  ...
                  <div className="owl-carousel owl-theme">
                     <div className="item">
                        <div className="protect_box text_align_center">
                          <div className="desktop">
                             <i><img src="assets/images/pro1.png" alt="#"/></i>
                           <h3> Wear Mask</h3>
                           ...
                           <a className="read_more" href="protect.html">Read More</a>
                        </div>
                     </div>
                     <div className="item">
                          <div className="protect_box text_align_center">
                          <div className="desktop">
                             <i><img src="assets/images/pro2.png" alt="#"/></i>
                     ...
                     <div className="item">
                         <div className="protect_box text_align_center">
                          <div className="desktop">
                             <i><img src="assets/images/pro3.png" alt="#"/></i>
                           <h3> Stay at Home</h3>
                           <span> Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for</span>
                          </div>
                           <a className="read_more" href="protect.html">Read More</a>
               ...
               <div className=" col-md-4">
                  <div className="latest text_align_center">
                     <figure><img src="assets/images/cases1.png" alt="#"/></figure>
                      <a className="read_more" href="cases.html">Read More</a>
            ...
            <div className="row d_flex">
               <div className=" col-md-6">
                     <div id="ho_efcet" className="reader text_align_center">
                        <i><img src="assets/images/doctor1.png" alt="#"/></i>
                        <h3>Dr.Golap den</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
                        <span><img src="assets/images/do.png" alt="#"/></span>
                          ...
                          <div className=" col-md-6">
                     <div id="ho_efcet" className="reader text_align_center">
                        <i><img src="assets/images/doctor2.png" alt="#"/></i>
                        <h3>Dr.Golap den</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
                        <span><img src="assets/images/do.png" alt="#"/></span>
                     </div>
         ...
         <div className="row">
            <div className="col-md-12">
               <form id="colof" className="form_subscri">
                  <input className="newsl" placeholder="Your Email" type="text" name="Email"/>
